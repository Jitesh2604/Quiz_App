...
export default function QuizPage({ questions, onFinishQuiz }) {
    ...
    const handleNextQuestion = () => {
        ...
        if (currentQuestionIndex < questions.length - 1) {
            ...
            onFinishQuiz(score + (selectedAnswer === currentQuestion.correctAnswer ? (isAnswered ? 0 : 1) : 0), questions.length);
        }
    };
    ...
    return (
        <div className="max-w-3xl mx-auto py-8 animate-fade-in">
            <div className="bg-gray-800/60 backdrop-blur-xl p-8 rounded-2xl shadow-2xl border border-gray-700">
                <div className="mb-6">
                    <p className="text-lg text-gray-400">Question {currentQuestionIndex + 1} of {questions.length}</p>
